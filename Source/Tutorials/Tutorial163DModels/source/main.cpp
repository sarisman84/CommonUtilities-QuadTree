...
void Go(void)
{
...

    {
        ...
        std::vector<AnimationImportDefinition> animations;
        animations.push_back({L"../source/tutorials/Tutorial163DModels/data/CH_NPC_Undead@Idle_01_17G3_AN.fbx", true});
        animations.push_back({L"../source/tutorials/Tutorial163DModels/data/CH_NPC_Undead@Walk_01_17G3_AN.fbx", true});
